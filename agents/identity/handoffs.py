...
async def urgency_handoff_node(state: ConversationState) -> dict:
    """
    Node: handoff to a doctor
    - Reads the user info from the state
    - Hands off to a doctor
    """
    return {"messages": [AIMessage(content=
    """For urgent cases please call 911 immediately.
    If this is not an emergency, please confirm this is not an emergency and I can help you with your appointment.
    """)]}